...
<rect width="24" height="24" fill="white"/>
  ...
  return (
    <div className="w-screen min-h-screen bg-[#161618] text-white flex flex-col items-center px-4">

      {/* Shared Header + Subtitle */}
      <Password
        title="Reset Your Password"
        desc="Please enter your new password. We recommend you to use strong passwords."
      />

      {/* Form Section */}
      <div className="w-full max-w-[420px] flex flex-col gap-5 mt-[60px]">
        ...
        <div className="relative">
          <input
            ...
            className="w-full h-[50px] px-4 bg-transparent border border-[#4C4C52]
                       rounded-md text-[16px] text-white outline-none focus:border-white"
          />

          <span
            className="absolute right-4 top-[14px] cursor-pointer"
            dangerouslySetInnerHTML={{ __html: showPass ? eyeOpen : eyeClosed }}
        ...
        <div className="relative">
          ...
          <span
            className="absolute right-4 top-[14px] cursor-pointer"
            dangerouslySetInnerHTML={{ __html: showCPass ? eyeOpen : eyeClosed }}
            onClick={() => setShowCPass(!showCPass)}
          />
        </div>

        {/* Reset Password Button (Custom Width) */}
        <div className="w-full mx-auto mt-10">
          <UniversalButton text="Reset Password" href="#" fullWidth />
        </div>
