    ...
    <section className="w-full min-h-screen flex">
      ...
      <div className="w-1/2 min-h-screen bg-[#161618] text-white flex flex-col justify-center relative">
        ...
        <div className="flex flex-col items-center -mt-6">
          <div className="flex items-center justify-center bg-[#3381F8] w-116 h-16 px-2 py-1 rounded-[10px]">
          <p className="font-bold text-[20px] text-[#FFFFFF] text-center">Your password has been successfully reset!</p>
        </div>
        </div>
